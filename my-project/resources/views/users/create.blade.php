...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bi bi-person-plus-fill me-2"></i>Nouvel Utilisateur</h2>
...
@push('scripts')
<script>
    // Afficher/masquer les champs entreprise selon le rôle sélectionné
    ...
    // Initialiser au chargement (pour old() values)
