...
<div class="mb-6">
    <a href="{{ route('student.offres.index') }}" class="text-sm font-bold text-gray-500 hover:text-indigo-600 flex items-center transition">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
    ...
    {{-- Sidebar: Match AI & One-Click Apply --}}
    <div class="space-y-6">
